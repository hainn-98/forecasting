...
class RevenueExpenditureListApi(APIView):
    ...
    def get(self, request, start, end):
        ...
        user = request.user
        revenue_expenditures = list(RevenueExpenditure.objects.filter(organization=user.client, month__gte=start_month, year=start_year) | RevenueExpenditure.objects.filter(organization=user.client, year__gte=start_year, year__lte=end_year) | RevenueExpenditure.objects.filter(organization=user.client, month__lte=end_month, year=end_year))              
